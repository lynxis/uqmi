...
static const struct osmo_fsm_state modem_states[] = {
	...
	.out_state_mask = S(MODEM_ST_GET_VERSION) | S(MODEM_ST_FAILED) |
			  S(MODEM_ST_DESTROY),
	.name = "RESYNC",
    ...
    [MODEM_ST_POWEROFF] = {
	.in_event_mask = S(MODEM_EV_RX_POWEROFF) | S(MODEM_EV_RX_POWERON) |
	...
	.out_state_mask =
	S(MODEM_ST_CONFIGURE_KERNEL) | S(MODEM_ST_DESTROY),
    ...
    {
	.in_event_mask =
	S(MODEM_EV_RX_REGISTERED) | S(MODEM_EV_RX_UNREGISTERED) |
	S(MODEM_EV_RX_SEARCHING) | S(MODEM_EV_RX_FAILED) |
