...
static int
uqmid_handle_restart(struct ubus_context *ctx, struct ubus_object *obj,
...
static int
uqmid_handle_reload(struct ubus_context *ctx, struct ubus_object *obj,
		     struct ubus_request_data *req, const char *method,
		     struct blob_attr *msg)
{
	if (uqmid_reload())
...
static int
enable_gsmtap(struct ubus_context *ctx, struct ubus_object *obj,
	     struct ubus_request_data *req, const char *method,
	     struct blob_attr *msg)
{
...
static int
disable_gsmtap_policy(struct ubus_context *ctx, struct ubus_object *obj,
		      struct ubus_request_data *req, const char *method,
		      struct blob_attr *msg)
{
	gsmtap_disable();
...
static int
add_modem(struct ubus_context *ctx, struct ubus_object *obj,
		      struct ubus_request_data *req, const char *method,
		      struct blob_attr *msg)
{
...
static int
remove_modem(struct ubus_context *ctx, struct ubus_object *obj,
		      struct ubus_request_data *req, const char *method,
		      struct blob_attr *msg)
{
...
void
uqmid_ubus_modem_notify_change(struct modem *modem, int event)
{
	/* TODO: */
}

static void
uqmid_ubus_reconnect_timer(struct uloop_timeout *timeout)
{
...
static void
uqmid_ubus_connection_lost(struct ubus_context *ctx)
{
...
static struct ubus_object_type main_object_type =
	UBUS_OBJECT_TYPE("uqmid", main_object_methods);
...
static int
modem_remove(struct ubus_context *ctx, struct ubus_object *obj,
		      struct ubus_request_data *req, const char *method,
		      struct blob_attr *msg)
{
...
static int
modem_configure(struct ubus_context *ctx, struct ubus_object *obj,
		      struct ubus_request_data *req, const char *method,
		      struct blob_attr *msg)
{
	struct modem *modem = container_of(obj, struct modem, ubus);
...
static int
modem_get_opmode(struct ubus_context *ctx, struct ubus_object *obj,
	    struct ubus_request_data *req, const char *method,
	    struct blob_attr *msg)
{
	struct modem *modem = container_of(obj, struct modem, ubus);
...
static int
modem_networkstatus(struct ubus_context *ctx, struct ubus_object *obj,
		 struct ubus_request_data *req, const char *method,
		 struct blob_attr *msg)
{
	struct modem *modem = container_of(obj, struct modem, ubus);
...
static void
blob_add_addr(struct blob_buf *blob, const char *name, struct sockaddr *addr)
{
...
static int
modem_dump_state(struct ubus_context *ctx, struct ubus_object *obj,
		 struct ubus_request_data *req, const char *method,
		 struct blob_attr *msg)
{
	struct modem *modem = container_of(obj, struct modem, ubus);
...
int
uqmid_ubus_init(const char *path)
{
	int ret;
